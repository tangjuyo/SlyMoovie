...
public class SearchByKeyword extends AppCompatActivity {
        ...
        Ion.with(getApplicationContext())
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        list.setLayoutManager(new LinearLayoutManager(SearchByKeyword.this, LinearLayoutManager.HORIZONTAL,false));
    ...
    public void Research(View v){
        TextView t = findViewById(R.id.keywords);

        String url = "https://api.themoviedb.org/3/search/movie?api_key="+ APIKEY + "&language=fr&query=" + t.getText().toString().replace(" ","%20")
